...
#define CYBLE_DELIGHT_LAMP_SERVICE_INDEX   (0x00u) /* Index of Delight Lamp service in the cyBle_customs array */
#define CYBLE_DELIGHT_LAMP_DELIGHT_LAMP_CONTROL_CHAR_INDEX   (0x00u) /* Index of Delight Lamp Control characteristic */
#define CYBLE_DELIGHT_LAMP_DELIGHT_LAMP_CONTROL_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_DELIGHT_LAMP_DELIGHT_LAMP_CONTROL_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x01u) /* Index of Characteristic User Description descriptor */


#define CYBLE_DELIGHT_LAMP_SERVICE_HANDLE   (0x000Cu) /* Handle of Delight Lamp service */
#define CYBLE_DELIGHT_LAMP_DELIGHT_LAMP_CONTROL_DECL_HANDLE   (0x000Du) /* Handle of Delight Lamp Control characteristic declaration */
#define CYBLE_DELIGHT_LAMP_DELIGHT_LAMP_CONTROL_CHAR_HANDLE   (0x000Eu) /* Handle of Delight Lamp Control characteristic */
#define CYBLE_DELIGHT_LAMP_DELIGHT_LAMP_CONTROL_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x000Fu) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_DELIGHT_LAMP_DELIGHT_LAMP_CONTROL_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0010u) /* Handle of Characteristic User Description descriptor */
