...
{   
    ...
    */
    ...
    /** Applies median filter on the input lines: 0 ¡V not applied, 1 ¡V applied.
    */
    uint32 enableMedianFilter;
    
    /** Applies late sampling of MISO line: 0 ¡V not applied, 1 ¡V applied.
     *  Ignored for slave mode.
    */
    uint32 enableLateSampling;
    
    /** Enables wakeup from low power mode: 0 ¡V disable, 1 ¡V enable. 
    ...
    */
    ...
    /** Enables component interrupt: 0 ¡V disable, 1 ¡V enable.
    ...
    */
     ...
     *  16 bytes: 0 ¡V disable, 1 ¡V enable. This implies that number of 
    ...
    */
    ...
    /** Enables continuous SCLK generation by the SPI master: 0 ¡V disable, 
     *  1 ¡V enable.
     *
     *  Ignored for all devices other than PSoC 4100 BLE / PSoC 4200 BLE / 
     *  PSoC 4100M / PSoC 4200M / PSoC 4200L / PSoC 4000S / PSoC 4100S / 
    ...
    */
     ...
     *  polarity, bit UART_1_SPI_SLAVE_SELECT1 ¡V slave select 1 
...
typedef struct
{
    ...
    */
    ...
    /** Enables IrDA low power RX mode operation: 0 ¡V disable, 1 ¡V enable.
    ...
    */
    ...
    /** Enables retry when NACK response was received: 0 ¡V disable, 1 ¡V enable. 
     *  Only current content of TX FIFO is re-sent.
     *  Ignored for modes other than SmartCard.
    */
    uint32 enableRetryNack;
    
    /** Inverts polarity of RX line: 0 ¡V non-inverting, 1 ¡V inverting. 
     *  Ignored for modes other than IrDA.
    */
    uint32 enableInvertedRx;
    
    /** Drop data from RX FIFO if parity error is detected: 0 ¡V disable, 
     *  1 ¡V enable. 
    */
    uint32 dropOnParityErr;
    
    /** Drop data from RX FIFO if a frame error is detected: 0 ¡V disable, 
     *  1 ¡V enable.
    */
    ...
    */
    ...
    /** Enables multiprocessor mode: 0 ¡V disable, 1 ¡V enable.
    */
    uint32 enableMultiproc;
    
    /** Enables matched address to be accepted: 0 ¡V disable, 1 ¡V enable.
    */
    ...
    */
     ...
     *  - Bit value 0 ¡V excludes bit from address comparison.
     *  - Bit value 1 ¡V the bit needs to match with the corresponding bit 
    ...
    */
    ...
    /** Enables usage of CTS input signal by the UART transmitter : 0 ¡V disable,
     *  1 ¡V enable.
     *
     *  Ignored for all devices other than PSoC 4100 BLE / PSoC 4200 BLE / 
     *  PSoC 4100M / PSoC 4200M / PSoC 4200L / PSoC 4000S / PSoC 4100S / 
