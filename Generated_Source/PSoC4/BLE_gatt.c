    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'D', (uint8)'e', (uint8)'l', (uint8)'i', (uint8)'g', (uint8)'h', (uint8)'t', (uint8)' ', (uint8)'B',
    (uint8)'L', (uint8)'E',
    ...
    /* Delight Lamp Control */
    0x00u, 0x00u, 0x00u, 0x00u,

    /* Characteristic User Description */
    (uint8)'D', (uint8)'e', (uint8)'l', (uint8)'i', (uint8)'g', (uint8)'h', (uint8)'t', (uint8)' ', (uint8)'L',
    (uint8)'a', (uint8)'m', (uint8)'p', (uint8)' ', (uint8)'C', (uint8)'o', (uint8)'n', (uint8)'t', (uint8)'r',
    (uint8)'o', (uint8)'l',

    /* Manufacturer Name String */
    (uint8)'M', (uint8)'a', (uint8)'t', (uint8)'h', (uint8)'b', (uint8)'r', (uint8)'i', (uint8)'g', (uint8)'h',
    (uint8)'t', (uint8)' ', (uint8)'T', (uint8)'e', (uint8)'c', (uint8)'h', (uint8)'n', (uint8)'o', (uint8)'l',
    (uint8)'o', (uint8)'g', (uint8)'y', (uint8)' ', (uint8)'C', (uint8)'o', (uint8)'.', (uint8)',', (uint8)' ',
    (uint8)'L', (uint8)'t', (uint8)'d', (uint8)'.',

    /* Model Number String */
    (uint8)'M', (uint8)'B', (uint8)'0', (uint8)'6', (uint8)'5', (uint8)'A', (uint8)'-', (uint8)'M', (uint8)'1',
    (uint8)'3', (uint8)'B', (uint8)'N',

    /* Serial Number String */
    (uint8)'D', (uint8)'-', (uint8)'B', (uint8)'-', (uint8)'1', (uint8)'7', (uint8)'0', (uint8)'6', (uint8)'-',
    (uint8)'0', (uint8)'0', (uint8)'0', (uint8)'0', (uint8)'1',

    /* Hardware Revision String */
    (uint8)'V', (uint8)'1', (uint8)'.', (uint8)'0',

    /* Firmware Revision String */
    (uint8)'V', (uint8)'1', (uint8)'.', (uint8)'0',

    /* Software Revision String */
    (uint8)'D', (uint8)'e', (uint8)'l', (uint8)'i', (uint8)'g', (uint8)'h', (uint8)'t', (uint8)' ', (uint8)'T',
    (uint8)'o', (uint8)'o', (uint8)'l',
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0004u, (void *)&cyBle_attValues[25] }, /* Delight Lamp Control */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[2] }, /* Client Characteristic Configuration */
    { 0x0014u, (void *)&cyBle_attValues[29] }, /* Characteristic User Description */
    { 0x001Fu, (void *)&cyBle_attValues[49] }, /* Manufacturer Name String */
    { 0x000Cu, (void *)&cyBle_attValues[80] }, /* Model Number String */
    { 0x000Eu, (void *)&cyBle_attValues[92] }, /* Serial Number String */
    { 0x0004u, (void *)&cyBle_attValues[106] }, /* Hardware Revision String */
    { 0x0004u, (void *)&cyBle_attValues[110] }, /* Firmware Revision String */
    { 0x000Cu, (void *)&cyBle_attValues[114] }, /* Software Revision String */
    { 0x0008u, (void *)&cyBle_attValues[126] }, /* System ID */
    { 0x0001u, (void *)&cyBle_attValues[134] }, /* IEEE 11073-20601 Regulatory Certification Data List */
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x23u] = {
    ...
    { 0x000Du, 0x2803u /* Characteristic                      */, 0x001A0001u /* rd,wr,ntf */, 0x0010u, {{0xCBB1u, NULL}}                           },
    { 0x000Eu, 0xCBB1u /* Delight Lamp Control                */, 0x011A0101u /* rd,wr,ntf */, 0x0010u, {{0x0004u, (void *)&cyBle_attValuesLen[5]}} },
    { 0x000Fu, 0x2902u /* Client Characteristic Configuration */, 0x010A0101u /* rd,wr     */, 0x000Fu, {{0x0002u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x0010u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd        */, 0x0010u, {{0x0014u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x0011u, 0x2800u /* Primary service                     */, 0x00000001u /*           */, 0x0023u, {{0x180Au, NULL}}                           },
    { 0x0012u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd        */, 0x0013u, {{0x2A29u, NULL}}                           },
    { 0x0013u, 0x2A29u /* Manufacturer Name String            */, 0x01020001u /* rd        */, 0x0013u, {{0x001Fu, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0014u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd        */, 0x0015u, {{0x2A24u, NULL}}                           },
    { 0x0015u, 0x2A24u /* Model Number String                 */, 0x01020001u /* rd        */, 0x0015u, {{0x000Cu, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0016u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd        */, 0x0017u, {{0x2A25u, NULL}}                           },
    { 0x0017u, 0x2A25u /* Serial Number String                */, 0x01020001u /* rd        */, 0x0017u, {{0x000Eu, (void *)&cyBle_attValuesLen[10]}} },
    { 0x0018u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd        */, 0x0019u, {{0x2A27u, NULL}}                           },
    { 0x0019u, 0x2A27u /* Hardware Revision String            */, 0x01020001u /* rd        */, 0x0019u, {{0x0004u, (void *)&cyBle_attValuesLen[11]}} },
    { 0x001Au, 0x2803u /* Characteristic                      */, 0x00020001u /* rd        */, 0x001Bu, {{0x2A26u, NULL}}                           },
    { 0x001Bu, 0x2A26u /* Firmware Revision String            */, 0x01020001u /* rd        */, 0x001Bu, {{0x0004u, (void *)&cyBle_attValuesLen[12]}} },
    { 0x001Cu, 0x2803u /* Characteristic                      */, 0x00020001u /* rd        */, 0x001Du, {{0x2A28u, NULL}}                           },
    { 0x001Du, 0x2A28u /* Software Revision String            */, 0x01020001u /* rd        */, 0x001Du, {{0x000Cu, (void *)&cyBle_attValuesLen[13]}} },
    { 0x001Eu, 0x2803u /* Characteristic                      */, 0x00020001u /* rd        */, 0x001Fu, {{0x2A23u, NULL}}                           },
    { 0x001Fu, 0x2A23u /* System ID                           */, 0x01020001u /* rd        */, 0x001Fu, {{0x0008u, (void *)&cyBle_attValuesLen[14]}} },
    { 0x0020u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd        */, 0x0021u, {{0x2A2Au, NULL}}                           },
    { 0x0021u, 0x2A2Au /* IEEE 11073-20601 Regulatory Certifi */, 0x01020001u /* rd        */, 0x0021u, {{0x0001u, (void *)&cyBle_attValuesLen[15]}} },
    { 0x0022u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd        */, 0x0023u, {{0x2A50u, NULL}}                           },
    { 0x0023u, 0x2A50u /* PnP ID                              */, 0x01020001u /* rd        */, 0x0023u, {{0x0007u, (void *)&cyBle_attValuesLen[16]}} },
};
