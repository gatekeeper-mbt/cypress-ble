...
const CYBLE_DISS_T cyBle_diss =
{
    0x0011u,    /* Handle of the DIS service */
    {
        ...
        0x0017u, /* Handle of the Serial Number String characteristic */ 
        0x0019u, /* Handle of the Hardware Revision String characteristic */ 
        0x001Bu, /* Handle of the Firmware Revision String characteristic */ 
        0x001Du, /* Handle of the Software Revision String characteristic */ 
        0x001Fu, /* Handle of the System ID characteristic */ 
        0x0021u, /* Handle of the IEEE 11073-20601 Regulatory Certification Data List characteristic */ 
        0x0023u, /* Handle of the PnP ID characteristic */ 
    },
};
