...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* Delight Lamp service */
    {
        0x000Cu, /* Handle of the Delight Lamp service */ 
        {

            /* Delight Lamp Control characteristic */
            {
                0x000Eu, /* Handle of the Delight Lamp Control characteristic */ 
